...
type TableName = 'problems' | 'problems_oge_100' | 'problems_pandoc' | 'pandoc';
...
export function useSupabaseConnection() {
  ...
  const [availableTables, setAvailableTables] = useState<string[]>(['problems', 'problems_oge_100', 'problems_pandoc', 'pandoc']);
