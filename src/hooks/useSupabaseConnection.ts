...
type TableName = 'problems' | 'problems_oge_100' | 'problems_pandoc' | 'pandoc' | 'latex_for_mathjax_by_python' | 'OGE_SHFIPI_problems_1_25';
...
export function useSupabaseConnection() {
  ...
  const [availableTables, setAvailableTables] = useState<string[]>(['problems', 'problems_oge_100', 'problems_pandoc', 'pandoc', 'latex_for_mathjax_by_python', 'OGE_SHFIPI_problems_1_25']);
